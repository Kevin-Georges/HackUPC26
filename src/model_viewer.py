...
class ModelViewer(QOpenGLWidget):
    ...
    def paintGL(self):
        ...
        # Pick after transforms are applied so gluUnProject reads correct matrices
    ...
    def _do_pick_cpu(self, px: int, py: int) -> None:
        ...
        then tests it against every triangle of every mesh on the CPU.
        No framebuffer manipulation — completely crash-safe.
        """
        try:
